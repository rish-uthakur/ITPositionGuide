...
export default function DigitalMarketingSpecialist() {
  ...
  const digitalMarketingSpecialist: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 24);
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {digitalMarketingSpecialist && (
          <>
            <ColorfulCard
              title={digitalMarketingSpecialist.name || "Digital Marketing Specialist"}
              content={
                <p className="text-lg text-gray-700">
                  {digitalMarketingSpecialist.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <p className="text-lg text-gray-700">
                  {digitalMarketingSpecialist.salaryRange}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {digitalMarketingSpecialist.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.certifications.map(
                    (certification, index) => (
                      <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {digitalMarketingSpecialist.resourcesForLearning.map((resource, index) => {
