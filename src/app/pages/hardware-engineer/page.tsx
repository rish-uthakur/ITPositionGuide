...
export default function HardwareEngineer() {
  ...
  const hardwareEngineer: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 30);
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {hardwareEngineer && (
          <>
            <ColorfulCard
              title={hardwareEngineer.name || "Hardware Engineer"}
              content={
                <p className="text-lg text-gray-700">
                  {hardwareEngineer.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.responsibilities.map((responsibility, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {hardwareEngineer.careerProgression.map((progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.certifications.map((certification, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.commonInterviewQuestions.map((question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {hardwareEngineer.resourcesForLearning.map((resource, index) => {
