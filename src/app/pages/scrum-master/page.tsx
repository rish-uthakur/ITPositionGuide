...
export default function ScrumMaster() {
  ...
  const scrumMaster: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 27);
        ...
        {scrumMaster && (
          <>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.responsibilities.map((responsibility, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {scrumMaster.careerProgression.map((progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.certifications.map((certification, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.commonInterviewQuestions.map((question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {scrumMaster.resourcesForLearning.map((resource, index) => {
