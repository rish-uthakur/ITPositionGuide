...
export default function SecurityEngineer() {
  ...
  const securityEngineer: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 23);
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {securityEngineer && (
          <>
            <ColorfulCard
              title={securityEngineer.name || "Security Engineer"}
              content={
                <p className="text-lg text-gray-700">
                  {securityEngineer.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.responsibilities.map(
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {securityEngineer.careerProgression.map(
                    (progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.certifications.map((certification, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer.commonInterviewQuestions.map(
                    (question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {securityEngineer?.resourcesForLearning.map((resource, index) => {
