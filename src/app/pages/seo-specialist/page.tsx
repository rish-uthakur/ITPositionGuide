...
export default function SEOSpecialist() {
  ...
  const seoSpecialist: Position | undefined =
    transformedPositions.find((position: Position) => position.id === 28);
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        {seoSpecialist && (
          <>
            <ColorfulCard
              title={seoSpecialist.name || "SEO Specialist"}
              content={
                <p className="text-lg text-gray-700">
                  {seoSpecialist.description}
                </p>
              }
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.skills.map((skill, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.responsibilities.map((responsibility, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.examples.map((example, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <>
                  {seoSpecialist.careerProgression.map((progression, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.certifications.map((certification, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.keyTools.map((tool, index) => (
                    <li key={index}>
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.futureScope.map((scope, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.challenges.map((challenge, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.commonInterviewQuestions.map((question, index) => (
            ...
            <ColorfulCard
              ...
              content={
                <ul className="list-disc pl-6 text-gray-700">
                  {seoSpecialist.resourcesForLearning.map((resource, index) => {
